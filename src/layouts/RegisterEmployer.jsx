  ...
  return (
    <div>
      <Header as="h2" color="teal" textAlign="center">
        <Image src /> İşveren Olarak Kayıt Ol
      </Header>
      <Form size="large" onSubmit={formik.handleSubmit} style={{alignItems:"center"}}>
        <Segment stacked>
        <div style={{marginTop:"1em"}}>
          ...
          <Grid stackable>            
            <Grid.Column width={8}>
              <div >
                <label><b>Telefon Numarası</b> (Başında sıfır olmadan yazınız)</label>
                <Form.Input
                  fluid
                  icon="phone"
                  iconPosition="left"
